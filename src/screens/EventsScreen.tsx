...
export default function EventsScreen() {
  ...
  async function fetchEvents() {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${API_BASE_URL}/api/events?school=${encodeURIComponent(userProfile.school)}`);
      if (response.ok) {
    ...
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <FlatList
            ...
            <View style={styles.card}>
              ...
              <View style={styles.cardContent}>
                ...
                <View style={styles.row}>
                  ...
                  <Text style={styles.cardMeta}>{item.timings}</Text>
                </View>
                <View style={styles.row}>
          ...
          ListEmptyComponent={<Text style={styles.empty}>No upcoming events for {userProfile?.school || 'your school'}.</Text>}
        />
      )}
      ...
      <Modal visible={modalVisible} animationType="slide" presentationStyle="pageSheet">
        <View style={styles.modalContainer}>
          ...
          <ScrollView style={styles.form}>
            ...
            <TextInput style={styles.input} value={title} onChangeText={setTitle} placeholder="e.g. Manthan AI 2025" />
            ...
            <TextInput style={styles.input} value={timings} onChangeText={setTimings} placeholder="e.g. 10:00 AM onwards" />

            <Text style={styles.label}>Venue</Text>
            <TextInput style={styles.input} value={location} onChangeText={setLocation} placeholder="e.g. A BLOCK, Room 213" />
